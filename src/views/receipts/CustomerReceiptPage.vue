<template>
  <div>
    ...
    <div class="h-screen overflow-y-auto flex flex-col gap-3 items-center bg-slate-100 dark:bg-slate-900 pt-4 pb-20 px-4">
      <!-- Member Info Banner -->
      <div class="w-full max-w-3xl bg-gradient-to-r from-emerald-500 to-teal-600 text-white p-3 rounded-lg shadow-md flex items-center justify-between">
      ...
      <section class="w-full max-w-3xl bg-white dark:bg-slate-800 p-4 rounded-xl shadow-lg">
        <div class="flex items-center justify-between flex-wrap gap-2.5">
          ...
          <div class="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p class="text-xs text-slate-500 dark:text-slate-400">Complete receipt with customer payment details</p>
            </div>
          </div>
        </div>
