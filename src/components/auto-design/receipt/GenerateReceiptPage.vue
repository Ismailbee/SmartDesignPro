      ...
      <section class="w-full max-w-4xl">
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-4 border border-gray-200 dark:border-gray-700">
          <div class="flex items-center justify-between mb-3">
            <div class="flex items-center gap-1.5">
              ...
              <h2 class="text-base font-semibold text-slate-900 dark:text-white">
                📝 Generate Receipt Quick Fill Form
              </h2>
            </div>
          ...
          <p class="text-xs text-slate-600 dark:text-slate-300 mb-3">
            Set up your organization details to generate a quick receipt
          </p>
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      const savedFormData = localStorage.getItem('generateReceiptFormData');
      if (savedFormData) {
        try {
    ...
    const saveFormData = () => {
      ...
      localStorage.setItem('generateReceiptFormData', JSON.stringify(formData));
    };
    ...
    const handlePreviewClick = () => {
      ...
      // Save preview data for receipt preview page
      const previewData = {
        organizationName: organizationName.value,
        organizationSubName: organizationSubName.value,
        organizationAddress: organizationAddress.value,
