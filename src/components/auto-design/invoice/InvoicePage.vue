...
// Lazy load heavy export libraries - only needed when exporting
  ...
  setup() {
    ...
    const handleExportPDF = async () => {
      ...
      try {
        ...
        // Export using the original element exactly as it appears (lazy load)
    ...
    const handleExportJPEG = async () => {
      ...
      try {
        ...
        // Export using the original element exactly as it appears - no dimension overrides (lazy load)
